      ...
      <div className="not-found-content">
        ...
        <div className="beach-scene">
          ...
          >
            ...
            {/* Sombrilla */}
            <line x1="50" y1="80" x2="50" y2="60" stroke="brown" strokeWidth="1" />
            <polygon points="45,60 55,60 50,50" fill="red" />
            {/* Silla */}
            <rect x="30" y="75" width="10" height="5" fill="brown" />
            <line x1="30" y1="75" x2="40" y2="80" stroke="brown" strokeWidth="1" />
            <line x1="40" y1="75" x2="30" y2="80" stroke="brown" strokeWidth="1" />
            {/* Nube */}
        ...
        {/* Mensaje de error */}
        <h1>{isSpanish ? "¡Oh no! Página no encontrada" : "Oops! Page Not Found"}</h1>
        <p>
          {isSpanish
