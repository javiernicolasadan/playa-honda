      ...
      >
        <div className="row justify-content-evenly grid-row" style={{ gap: "2rem" }}>
          <article className="p-3 col-xl-4 col-xl-3 col-md-4 col-sm-6 col-12 grid-item item-1">
              ...
              <h4>Playa Honda</h4>
              <img src="/atardecer4_resultado.webp" loading="lazy" alt="Atardecer en Playa Honda" className="mb-3"/>
          ...
          <article className="p-3 col-xl-4 col-xl-3 col-md-4 col-sm-6 col-12 grid-item item-2">
            <h4>Cabo de palos</h4>
            <div>
              <img src="/faro_resultado.webp" loading="lazy" alt="Faro de Cabo de Palos" className="mb-3"/>
            </div>
            <p>
          ...
          <article className="p-3 col-xl-4 col-xl-3 col-md-4 col-sm-6 col-12 grid-item item-3">
            ...
            <div>
              <img src="/laManga_resultado.webp" loading="lazy" alt="Vista aérea de La Manga" className="mb-3"/>
            </div>
            <p>
          ...
          <article className="p-3 col-xl-4  col-xl-3  col-md-4  col-sm-6 col-12 grid-item item-4">
            <h4>Calblanque</h4>
            <div>
              <img src="/calblanque_resultado.webp" loading="lazy" alt="Parque natural de Calblanque" className="mb-3"/>
            </div>
            <p>
